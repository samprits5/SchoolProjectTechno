...
<form action="{{ route('updateClass', $s->id) }}" method="POST" style="margin-top: 50px; border: 1px solid black; padding: 10px; background-color: #758AA2;">
    ...
    <input type="text" class="form-control" name="class_name" aria-describedby="emailHelp" placeholder="Enter class name" style="margin-bottom: 15px;" value="{{$s->name}}">
