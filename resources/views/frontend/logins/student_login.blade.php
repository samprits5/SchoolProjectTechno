...
<div class="row" style="margin-top: 80px;">
	...
	<form action="{{ route('loginStudent') }}" method="POST" style="border: 1px solid black; padding: 10px; background-color: #99AAAB; margin-left: 300px; margin-right: 300px; padding-top: 40px;">
      ...
      @csrf
	    ...
	    <label for="email" style="margin-bottom: 15px; float: left;">Student ID</label>

    <input type="text" class="form-control" name="email" aria-describedby="emailHelp" placeholder="Enter student id" style="margin-bottom: 15px;">
